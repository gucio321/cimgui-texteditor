...
local pipe,err = io.open("../ImGuiColorTextEdit/TextEditor.h","r")
if not pipe then
...
local modulename = "cimgui_textedit"
local headers = [[#include "../ImGuiColorTextEdit/TextEditor.h" 
]]
local headersT = {[[TextEditor]]}
if INTERNAL_GENERATION then
